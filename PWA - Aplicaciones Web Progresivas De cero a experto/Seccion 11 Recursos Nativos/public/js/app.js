...
postBtn.on('click', function() {
    ...
    fetch('api', {
        ...
        .catch(err => console.error('app.js', err));
...
function getMensajes() {
    fetch('api')
        ...
        .then(mensajes => {
            ...
            mensajes.forEach(mensaje => crearMensajeHTML(mensaje.mensaje, mensaje.user, mensaje.lat, mensaje.lng));
        });
}
...
function enviarNotificacion() {
    const notificationOpts = {
        body: 'Ese es el cuerpo de la notificación',
...
function getPublicKey() {
    ...
    */
    return fetch('api/key')
        ...
        //devuelve el array pero como un UintBarray
...
btnLocation.on('click', () => {
    ...
    if (!navigator.geolocation) {
        return console.log('Geolocalización no disponible');
    }

    $.mdtoast('Cargando coordenadas...', {
        interaction: true,
